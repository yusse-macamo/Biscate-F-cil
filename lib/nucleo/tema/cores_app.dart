...
/// Paleta de cores da aplicação e os `ColorScheme` claro e escuro
...
abstract final class CoresApp {
  ...
  static final ColorScheme esquemaClaro = ColorScheme.fromSeed(
    seedColor: primaria,
  ...
  static final ColorScheme esquemaEscuro = ColorScheme.fromSeed(
    seedColor: primariaEscura,
    brightness: Brightness.dark,
  ).copyWith(
    primary: primariaEscura,
    onPrimary: fundoEscuro,
    primaryContainer: primariaSuaveEscura,
    onPrimaryContainer: primariaPremidaEscura,
